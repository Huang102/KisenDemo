...
public class PathPoint {
     ...
     * 用于贝塞尔曲线坐标存储
     */
    public float mPathX1, mPathX2, mPathY1, mPathY2;
     ...
     * 存储贝塞尔曲线的运动轨迹坐标
     */
    public static PathPoint cubicTo(float pointX0, float pointY0, float pointX1, float pointY1, float pointX2, float pointY2) {
